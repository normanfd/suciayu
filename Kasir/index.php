            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Master Kasir</h4>
                            </div>
                            <div class="card-body">
                                <table class="table table-hover table-bordered" id="mytable" style="margin-top: 10px">
                                    ...
                                    <?php
                                        $no=1;
                                        $hasil = $proses->tampil_master_kasir();
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $isi['Alamat'];?></td>
                                                ...
                                                <td style="text-align: center;">
                                                    <a href="edit.php?id=<?php echo $isi['NIK'];?>" class="btn btn-success btn-md">
                                                    <span class="fa fa-edit"></span></a>
                                                    <a onclick="return confirm('Apakah yakin data akan di hapus?')" href="../proses/crud.php?aksi=hapus_kasir&hapusid=<?php echo $isi['NIK'];?>" 
